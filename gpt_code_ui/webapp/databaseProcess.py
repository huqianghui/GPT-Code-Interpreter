sql_code_prompt = """First, here is a history of what I asked you to do earlier. 
    ...
    Notes: 
        ...
        For mysql connector，you can use
            'mysql-python' # mysql-connector-python==8.1.0 
